...
import "../cssfiles/Home.css"; // Import separate CSS file
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_BASE_URL}/restaurants`)
      .then((res) => {
        console.log("Fetched restaurants:", res.data); // Debugging
    ...
    <div className="home-container">
      ...
      <div className="home-grid">
        {restaurants.length > 0 ? (
          restaurants
            .filter((r) => !selectedCuisine || r.cuisine_id === parseInt(selectedCuisine))
            .map((r) => (
              <Link
              ...
              >
                <img
                  src={r.image_url || "https://via.placeholder.com/300"}
                  alt={r.name}
